    ...
    return (
      <section className="p-8 bg-black text-white">
        ...
        <p className="p-2">
          ...
          una parte fundamental de la forma en que llevo el programa Xbox.
        </p>
        ...
        <ul className="list-disc list-inside p-2">
          ...
          <li>
            <strong>Contenido adecuado:</strong> Todo contenido compartido en la plataforma debe ser apropiado 
            para una audiencia amplia, evitando materiales ofensivos o explícitos.
          </li>
          <li>
            <strong>Seguridad en la plataforma:</strong> Xbox se compromete a proteger a todos los jugadores 
            de comportamientos abusivos y amenazas, promoviendo un entorno de juego seguro.
          </li>
          <li>
            <strong>Evitar el spam:</strong> Se prohíbe el spam y el uso de la plataforma para autopromoción 
            mediante tácticas engañosas o contenido no deseado.
          </li>
        </ul>
      </section>
    );
